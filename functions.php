...
function vibranium_enqueue_assets() {
    ...
    wp_enqueue_style( 'bootstrap-reboot', get_theme_file_uri() . '/assets/css/bootstrap-reboot.css', null, '4.1.3' );
    wp_enqueue_style( 'font-awesome', '//stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', null, '4.7' );
    wp_enqueue_style( 'owl-css', get_theme_file_uri() . '/assets/css/owl.carousel.min.css', null, '2.3.4' );
...
function vibranium_customizer_scripts() {
    wp_enqueue_style( 'vibranium-customizer-controls-styles', get_theme_file_uri( '/core-files/customizer/css/customizer-styles.css' ), array(), '1.0' );
    wp_enqueue_script( 'vibranium-customizer-controls-js', get_theme_file_uri( '/core-files/customizer/js/customizer-controls.js' ), array('jquery', 'customize-controls'), false, true );
}
...
// $body_font_family = cs_get_customize_option( 'vbm__body_font_family', 'Open Sans' );
// print_r( $body_font_family );
